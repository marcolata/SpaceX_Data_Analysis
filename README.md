...
Dataset was cleaned and exploratory analysis was performed using SQL to identify launch patterns.
Folium maps were created to analyze site proximity to infrastructure and a Plotly Dash dashboard for real-time success rate filtering.
Four classification models (Logistic Regression, SVM, KNN, and Decision Tree) were trained and tuned using GridSearchCV.
Check SX pdf file for a more detailed report.
